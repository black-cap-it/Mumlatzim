...
public class CustomAdapter extends ArrayAdapter<Comments> {

    private ArrayList<Comments> mCustomList;
    ...
    private static class ViewHolder {
        ...
        private View view;
        private CustomerAdapter mCustomerAdapter=null;
        private ListItemClickListener itemClickListener;

    }

    public CustomAdapter(Context mContext,ArrayList<Comments> mCustomList) {
    ...
    public View getView(int position, View itemView, ViewGroup parent) {
        ...
        final ViewHolder mainHolder; // view lookup cache stored in tag
        ...
        if (itemView == null) {
            ...
            {
                mainHolder = (ViewHolder) itemView.getTag();
            result=itemView;
        }
        ...
        if(model.getmLink()!=null && !model.getmLink().getmComments().isEmpty())
        {
            ...
            mainHolder.mCustomerAdapter=null;
                ...
                public void onResponse(Call<List<Comments>> call, Response<List<Comments>> response) {
                    ...
                    if (response.isSuccessful()) {
                        ...
                        if (totalPages > 1) {
                            ...
                            mainHolder.mCustomerAdapter=new CustomerAdapter(mContext,mReplyList);
                            mainHolder.listView.setAdapter(mainHolder.mCustomerAdapter);
