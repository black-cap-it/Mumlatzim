...
public class BookmarkDbController {
    ...
    public int insertData(int postId, String postImage, String postTitle, String postUrl, String postCategory, String postDate) throws SQLiteException{
    ...
    public ArrayList<BookmarkModel> getAllData() throws SQLiteException {
